...
<div class="mb-6 flex justify-between items-center">
  <div>
    <h2 class="text-2xl font-bold text-gray-900">Divisi Himpunan</h2>
    <p class="text-gray-600 text-sm mt-1">Daftar divisi dalam himpunan mahasiswa.</p>
  </div>
  ...
  <div class="overflow-x-auto">
    <table class="w-full text-left text-sm">
      ...
      <tbody class="divide-y divide-gray-50">
        ...
        {:else}
          <tr>
            <td colspan="2" class="px-6 py-8 text-center text-gray-500">Belum ada data.</td>
          </tr>
        {/each}
      </tbody>
    </table>
