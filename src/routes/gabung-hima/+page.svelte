...
<svelte:head>
  <title>Gabung HIMA FST — {siteConfig.name}</title>
</svelte:head>
    ...
    {#if isSuccess}
      ...
      <div class="bg-white rounded-[2.5rem] p-12 md:p-20 text-center shadow-[0_20px_50px_rgb(0,0,0,0.04)] border border-gray-100 fade-up">
        ...
        <p class="text-xl text-gray-500 mb-12 max-w-lg mx-auto">
          Terima kasih telah mendaftar menjadi bagian dari HIMA FST.
        </p>
        <Button href={siteConfig.himaGroup} target="_blank" class="py-4 px-10 text-lg">
          Gabung Grup HIMA FST <span class="ml-2">→</span>
        </Button>
      </div>
    {:else}
      <!-- Header -->
      <div class="mb-16 fade-up">
        ...
        <p class="text-xl text-gray-500 max-w-2xl leading-relaxed">
          Isi form di bawah ini dengan lengkap untuk bergabung menjadi bagian dari HIMA FST.
        </p>
      </div>
          ...
          <div class="pt-8 border-t border-gray-100">
            <div class="flex items-start mb-10">
              ...
              <div class="ml-4">
                ...
                <p class="text-gray-500 mt-1">Saya menyetujui data yang saya berikan digunakan untuk keperluan pendaftaran HIMA FST.</p>
              </div>
            </div>
