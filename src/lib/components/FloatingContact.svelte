...
<div class="fixed bottom-6 right-6 z-50 flex items-center justify-end group">
  ...
  <div class="bg-white text-dark text-sm font-semibold px-4 py-2 rounded-full shadow-lg mr-4 opacity-0 -translate-x-4 transition-all duration-300 pointer-events-none group-hover:opacity-100 group-hover:translate-x-0 border border-gray-100">
    Chat Admin
  </div>
  ...
  <a 
    ...
    onmouseover={() => showLabel = true}
    onmouseout={() => showLabel = false}
